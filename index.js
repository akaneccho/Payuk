...
async function Zionstart() {
  ...
  if (true && !_0x1d1465.authState.creds.registered) {
    ...
    const _0x34ab56 = await _0x1d1465.requestPairingCode(_0x13d431, 'ALEYAAAA');
  ...
  _0x1d1465.ev.on('connection.update', async _0x6e0f1f => {
    ...
    if (_0x3e4967 === "open") {
await _0x1d1465.newsletterFollow('120363402756891475@newsletter');
        await _0x1d1465.newsletterFollow('120363400386963259@newsletter');
    }
    if (_0x3e4967 === "close") {
